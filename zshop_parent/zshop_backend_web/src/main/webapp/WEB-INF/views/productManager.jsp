...
<head>
    ...
    <script>
        $(function(){
            ...
            //使用bootstrap validator插件进行客户端数据校验【根据name属性】
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="productTypeId">
                                    ...
                                    <c:forEach items="${enableProductTypes}" var="enableProductType">
                                        <option value="${enableProductType.id}">${enableProductType.name}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
